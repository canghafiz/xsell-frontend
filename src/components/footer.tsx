        ...
        <footer className="bg-black text-white py-12">
            <LayoutTemplate>
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8">
                    {/* Support Section */}
                    <div>
                        <h1 className="text-sm font-semibold mb-4">Support</h1>
                    ...
                    {/* Account Section */}
                    <div>
                        <h1 className="text-sm font-semibold mb-4">Account</h1>
                        <ul className="space-y-2 text-sm text-gray-300">
                            <li>
                    ...
                    {/* Quick Link Section */}
                    <div>
                        <h1 className="text-sm font-semibold mb-4">Quick Link</h1>
                        <ul className="space-y-2 text-sm text-gray-300">
                            <li>
                                <a href="#" className="hover:text-white transition">
                                    Privacy Policy
                    ...
                    {/* Categories Section */}
                    <div>
                        <h1 className="text-sm font-semibold mb-4">Categories</h1>
                        <ul className="space-y-2 text-sm text-gray-300">
                            <li>
                                <a href="#" className="hover:text-white transition">
                                    Electronics
