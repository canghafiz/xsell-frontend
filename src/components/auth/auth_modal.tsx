...
export default function AuthModal({ isOpen, onClose }: AuthModalProps) {
    ...
    const [activeContent, setActiveContent] = useState<"Sign In" | "Sign Up" | "Main">("Main");
            ...
            >
                ...
                {activeContent === "Main" ? (
                    <div className="p-8">
                        ...
                        {/* Title */}
                        <h1 className="text-center text-xl font-semibold text-gray-500 mb-2">
                        ...
                        <div className="flex gap-3 mb-6">
                            <button
                                ...
                                className={`cursor-pointer flex-1 py-3 rounded-lg font-medium transition-colors ${
                                    activeTab === "Sign In"
                        ...
                        <div className="space-y-3 mb-6">
                            {activeTab === "Sign In" ? (
                                <>
                                    <button
                                        className="w-full py-3 px-4 border-2 border-gray-300 rounded-lg flex items-center justify-center gap-3 hover:bg-gray-50 transition-colors">
                                    ...
                                    <PrimaryBtn
                                        ...
                                        variant="outline"
                                        size="lg"
                                        className="w-full justify-center border-gray-300 text-gray-900 hover:bg-gray-50"
                                    />
                                </>
                            ) : (
                                <>
